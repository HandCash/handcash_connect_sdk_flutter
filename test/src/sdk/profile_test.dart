...
void main() {
  ...
  final cloudAccount = HandCashConnect.fromAuthToken(authToken: token, environment: Environment.iae());
  ...
  group('Control errors', () {
    final accountWithoutToken = HandCashConnect.fromAuthToken(environment: Environment.iae());
    final accountErrorToken = HandCashConnect.fromAuthToken(
