...
void main() {
  ...
  HandCashConnect cloudAccount =
      HandCashConnect.fromAuthToken(authToken: token, environment: Environment.iae());
    ...
    final correctPaymentResult = PaymentResult(
      ...
      participants: [
        TransactionParticipant(
          ...
          displayName: "Rafa JS",
          profilePictureUrl: 'https://handcash-cloud-production.herokuapp.com/users/profilePicture/rjseibane',
          type: 'user',
        ),
        TransactionParticipant(alias: 'rjseibane', displayName: '', profilePictureUrl: '', type: 'user'),
      ],
