...
import 'package:handcash_connect_sdk/src/services/profile/entities/handle_request.dart';
...
class Profile {
  ...
  Future<List<UserPublicProfile>> getPublicProfilesByHandle(List<String> handles) async {
    final response = await _profileService.getPublicProfilesByHandleRequest(HandleRequest(aliases: handles));
